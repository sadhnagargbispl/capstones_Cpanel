...
public partial class FranchiseIncome : System.Web.UI.Page
{
    ...
    private void Fill_Grid()
    {
        try
        {
            ...
            DataSet Ds = new DataSet();
             str = Objdal.Isostart + " exec sp_GetFranchiseIncome '" + Session["FormNo"] + "' " + Objdal.IsoEnd;
            dt = SqlHelper.ExecuteDataset(constr1, CommandType.Text, str).Tables[0];
            Session["FranchiseIncome"] = dt;
            if (dt.Rows.Count > 0)
            {
