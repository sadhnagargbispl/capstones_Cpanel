<!DOCTYPE html>
<!-- saved from url=(0048)http://brandio.io/envato/iofrm/html/login17.html -->
            ...
            <div class="form-holder">
                <div class="form-content">
                    ...
                    <div class="form-items">
                        ...
                        <form>
                            <input class="input-xxlarge" type="text" name="username" placeholder="User Id" required="">
                            <input class="input-xxlarge" type="password" name="password" placeholder="Password" required="">
                            <div class="form-button">
                                <button id="submit" type="submit" class="ibtn"><a href="dashboard.asp">Login</a></button> <a href="forget.html">Forget password?</a>
                            </div>
                        </form>
