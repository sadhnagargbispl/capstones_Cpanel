            ...
            <div class="clearfix gen-profile-box" style="min-height: auto;">
                <div class="profile-bar clearfix" style="background: #fff;">
                    <div class="col-md-6">
                        ...
                        <div class="form-group" id="DiMemberId" runat="server" visible="false">
                        ...
                        <div class="form-group" id="DivMemberName" runat="server" visible="false">
                            <label for="inputdefault">
                                Member Name</label>
                        ...
                        <%--   <div runat="server" id="divotp" visible="false">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtOtp" onkeypress="return isNumberKey(event);" class="validate[required,minSize[6],maxSize[10]] input-xxlarge"
                                    TabIndex="51" runat="server" TextMode="Password" ValidationGroup="eInformation"
                                    autocomplete="off"></asp:TextBox>
                               
                            </div>
                            <div class="form-group">
                                <asp:Button ID="btnOtp" runat="server" Text="Send Request" class="btn btn-primary"
                                    ValidationGroup="Save1" OnClientClick="this.disabled=true; this.value='Sending Request…';"
