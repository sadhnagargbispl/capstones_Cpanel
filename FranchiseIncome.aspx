<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FranchiseIncome.aspx.cs" Inherits="FranchiseIncome" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Franchise Income</a><span class="divider-last">&nbsp;</span></li>
                </ul>
            </div>
        </div>
        <div>
                        ...
                        <div class="row">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-credit-card"></i>Franchise Income</h4>
                                    <span class="tools">
