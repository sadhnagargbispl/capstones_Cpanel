          ...
          <div class="span7"> 
              <div class="voucher-detail bg-light">
                                    <div class="p-3">
                                        ...
                                        <p align="justify">
                                            Click on redeem now and get 500 points for utilization on shopping. You will get
                                            coupons according to the package.
                                        </p>
                                        <p align="justify">
                                            Only one coupon can be redeemed in a month.
                                        </p>
                                        <input type="hidden" name="ctl00$ContentPlaceHolder1$RepVouDetail$ctl00$hdnKitiD" id="ContentPlaceHolder1_RepVouDetail_hdnKitiD_0" value="2" />
                                        ...
                                        <p align="justify">
                                            If you want to cancel voucher and return to Company. Then Company can pay current cancellation value of 200 . Cancellation value always depend on current
