...
public partial class EnterPool : System.Web.UI.Page
{
    string scrName;
    DAL objDal = new DAL();
    ...
    public string GetName()
    {
        try
        {
            ...
            else
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Key", "alert('This Id is blocked. Please Contact Admin.');location.replace('Index.aspx');", true);
                    return string.Empty;
                }
    ...
    protected void Fun_EnterPool()
    {
        try
        {
            ...
            {
                Response.Redirect("EnterPool.aspx");
            }
        }
        catch (Exception ex)
        {
    ...
    protected void FillKit()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                CmbKit.DataBind();
                txtAmount.Text = dt.Rows[0]["KitName"].ToString();
            }
            else
            {
                txtAmount.Text = "0";
