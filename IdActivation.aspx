                        ...
                        <div class="span12">
                            ...
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-credit-card"></i>Activation/Upgrade</h4>
                                    <span class="tools">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="form-group" id="Div1" runat="server" style="display: none;">
                                        <label for="inputdefault">
                                            Package</label>
...
<asp:Label ID="LblAmountUse" runat="server" Visible="false"></asp:Label>
                            ...
                            <div class="form-group ">
                                <label for="inputdefault">Wallet Password</label>
                                <asp:TextBox ID="TxtTransPass" runat="server" CssClass="input-xxlarge" TextMode="Password"></asp:TextBox>
                            </div>
                            <div class="form-group">
