...
function Node(id, pid, category, doj, UpgradeDate, name, nodename, upliner, sponsor, leftbv, rightbv, SelfTotalBV, DirctLeftActive, DirectRightActive, url, title, target, icon, iconOpen, open) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
...
dTree.prototype.add = function(id, pid, category, doj, UpgradeDate, name, nodename, upliner, sponsor, leftbv, rightbv,SelfTotalBV, DirctLeftActive, DirectRightActive, url, title, target, icon, iconOpen, open) {
this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, UpgradeDate, name, nodename, upliner, sponsor, leftbv, rightbv,SelfTotalBV, DirctLeftActive, DirectRightActive, url, title, target, icon, iconOpen, open);
};
...
str += '<table border="0" cellpadding="0" cellspacing="0" width="100%" >';
	...
	if (this.config.useIcons) {
		...
		strTable += '<tr>';
		strTable += '<td bgcolor=#277AB1><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Self PV</strong></font></td>';
		strTable += '<td><font FACE=Verdana SIZE=1>' + node.SelfTotalBV + '&nbsp;</td>';
		strTable += '</tr>';
