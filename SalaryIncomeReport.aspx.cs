...
public partial class SalaryIncomeReport : System.Web.UI.Page
{
    ...
    private void Fill_Grid()
    {
        try
        {
            ...
            str = Objdal.Isostart + " exec Sp_GetRankBonusSalary '" + Session["FormNo"] + "' " + Objdal.IsoEnd;
            dt = SqlHelper.ExecuteDataset(constr1, CommandType.Text, str).Tables[0];
            Session["RankBonusSalary"] = dt;
            if (dt.Rows.Count > 0)
            {
