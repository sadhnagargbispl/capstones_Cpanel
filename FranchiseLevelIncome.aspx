<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FranchiseLevelIncome.aspx.cs" Inherits="FranchiseLevelIncome" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Franchise Level Bonus</a><span class="divider-last">&nbsp;</span></li>
                </ul>
            </div>
        </div>
        <div>
                        ...
                        <div class="row">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-credit-card"></i>Franchise Level Bonus</h4>
                                    <span class="tools">
